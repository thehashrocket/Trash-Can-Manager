	...
	<?php if($customers->num_rows() > 0) : foreach ($customers->result() as $row): ?>
        ...
        <td>
            ...
            <td>
                ...
                <a href="/admin/custedit/<?=$row->custid ?>"><img alt="Edit Customer" src="/assets/images/icons/32x32/business_user_edit.png"><br/>Edit Customer</a>
            ...
            <td>
                ...
                <a href="/admin/createinvoice/<?=$row->custid ?>"><img alt="Create Invoice" src="/assets/images/icons/32x32/dollar_currency_sign.png"><br/>Make Invoice</a>

            </td>

            <td>

                <a href="/admin/receivepayment/<?=$row->custid ?>"><img alt="Receive Payment" src="/assets/images/icons/32x32/cash-in-mail.png"><br/>Receive Money</a>
        ...
        <td>
            ...
            <a href="/admin/archiveCustomer/<?=$row->custid ?>"><img alt="Archive Customer" src="/assets/images/icons/32x32/business_user_delete.png"><br/>Archive User</a>
