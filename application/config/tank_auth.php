...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'Trash Can Manager';
...
$config['recaptcha_public_key'] = '6Lesmb4SAAAAANQolMAuJUKYw2dMjEM8nf7DIwuL';
$config['recaptcha_private_key'] = '6Lesmb4SAAAAADHu4XYKos-wJPW5MPrz72HlUuLQ';
